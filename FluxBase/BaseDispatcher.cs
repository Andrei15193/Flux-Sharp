...
namespace FluxBase
{
    /// <summary>Represents the base implementation of a dispatcher. Follows the publish-subscribe pattern.</summary>
    public abstract class BaseDispatcher
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="BaseDispatcher"/> class.</summary>
        ...
        /// <summary>Enters a dispatch section, subsequent calls to this method will fault until <see cref="ExitDispatch"/> is called.</summary>
        /// <exception cref="InvalidOperationException">Thrown when the dispatcher is already dispatching an action.</exception>
        protected void EnterDispatch()
        {
        ...
        /// <summary>Exists a dispatch section allowing for <see cref="EnterDispatch"/> to be called again.</summary>
        protected void ExitDispatch()
        {
            Interlocked.Exchange(ref _state, _availableState);
        }

        /// <summary>Dispatches an action to all subscribed callbacks without checking if a dispatch is currently in progress.</summary>
        /// <param name="action">The action to dispatch.</param>
        protected void DispatchAction(object action)
        {
            try
            {
